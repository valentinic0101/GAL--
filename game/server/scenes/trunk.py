# -*- coding: utf-8 -*-
"""主干剧本数据：P1~P10 与终章 P0，全部正典台词与旁白整理自 资料/01_剧情文本/原文剧本.txt。
...
分歧与结局场景见 branches.py；本模块建立 SCENES 注册表，branches 挂在其上。
NOTE: 相位顺序 PHASE_ORDER 的唯一来源是 director.director（此处原有的同名副本无引用，已删除）。
"""
